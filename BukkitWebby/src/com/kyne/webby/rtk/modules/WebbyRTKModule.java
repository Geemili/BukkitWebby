...
public class WebbyRTKModule extends Module implements RTKListener {
	...
	private String getConfigFileContent() {
		...
		.append("webby:\n")
		.append(YAMLINDENT + "#Webserver port used to listen to web connections (Ex: http://loclahost:25567/login) (default = 25567)\n")
		.append(YAMLINDENT + "port: 25567\n")
		.append(YAMLINDENT + "#Local port used by the Webby RTKModule to communicate with the Webby Bukkit Plugin (default = 25564)\n")
	...
	public void backupServer(final boolean notifyForRestore) throws IOException {
		this.getBukkitInterface().backupServer(notifyForRestore);
	}
